(function(module) {
	mifosX.controllers = _.extend(module,{
			PaymentGatewayController : function(scope, webStorage, route, $modal, routeParams, location, resourceFactory, 
			...
			// for success Tab
				...
				*/
				...
				scope.edit = function(id) {								
					...
					scope.errorDetails = [];								
					scope.editId = id;								
					$modal.open({templateUrl : 'editpaymentgateway.html', controller : editpaymentgatewayController,								
						resolve : {}								
					});							
				};
	...
	'API_VERSION', 
	'$rootScope', 
	mifosX.controllers.PaymentGatewayController 
	]).run(function($log) {						
